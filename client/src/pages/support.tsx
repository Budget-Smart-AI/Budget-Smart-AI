...
const KB_ARTICLES: KBArticle[] = [
  ...
  // Billing
  { id: "sub-1", category: "billing", title: "What plans does BudgetSmart AI offer?", content: "BudgetSmart AI offers three subscription tiers: Free (basic transaction tracking, 1 connected account, limited AI queries), Plus ($9.99/month — unlimited accounts, full budgeting suite, AI Advisor, bill tracking, receipt scanning), and Premium ($19.99/month — everything in Plus, Financial Vault, investment tracking, household members, priority support, advanced AI insights). Annual billing saves 20% compared to monthly. All paid plans include a 14-day free trial." },
